	...
	protected function getContent() {
					...
					<table class="form-table">
						...
						<tr>
							...
							<td>
								...
								<input id="agentCrm" name="agentCrm" type="hidden" value="true" />
							</td>
						</tr>
					</table>
					<p class="submit">
		...
		<?php } else { ?>
			<?php if(!$this->admin->isActivated()) { ?>
				...
				<p>Signing up for a paid account provides access to listings in your MLS&reg; System and full support from iHomefinder. You must be a member of an MLS to qualify for IDX service. <a target="_blank" href="http://www.ihomefinder.com/mls-coverage/">Learn More</a></p>
				<p>
					<?php echo self::IHOMEFINDER_NOTIFICATION; ?>
				</p>
			<?php } else { ?>
